...
import { createUserWithEmailAndPassword, getAuth, GoogleAuthProvider, onAuthStateChanged, sendPasswordResetEmail, signInWithEmailAndPassword, signOut } from "firebase/auth";
...
const FIREBASE_ERROR_MESSAGE: Record<string, string> = {
  ...
  "auth/credential-already-in-use": "Thông tin đăng nhập này đã được sử dụng cho tài khoản khác.",
  ...
  "auth/cancelled-popup-request": "Yêu cầu đăng nhập bị hủy vì có yêu cầu khác đang xử lý.",
  "auth/unauthorized-domain": "Tên miền này chưa được cấp phép để sử dụng đăng nhập OAuth.",
  ...
  // --- Xác minh tài khoản ---
  "auth/requires-recent-login": "Hành động này yêu cầu bạn đăng nhập lại gần đây.",
  ...
  "auth/quota-exceeded": "Bạn đã vượt quá số lần thử xác minh cho phép. Vui lòng thử lại sau.",
  ...
  "auth/session-cookie-expired": "Cookie phiên đã hết hạn. Vui lòng đăng nhập lại.",
  ...
  "auth/app-not-authorized": "Ứng dụng này chưa được cấp quyền truy cập Firebase.",
  "auth/app-deleted": "Ứng dụng Firebase này đã bị xóa.",
  "auth/timeout": "Yêu cầu quá thời gian chờ, vui lòng thử lại.",

  // --- Giới hạn & Bảo vệ ---
  "auth/too-many-requests": "Bạn đã thử đăng nhập quá nhiều lần. Vui lòng thử lại sau.",
  "auth/maximum-second-factor-count-exceeded": "Đã đạt giới hạn số yếu tố xác thực thứ hai.",
...
export { createUserWithEmailAndPassword, GoogleAuthProvider, onAuthStateChanged, sendPasswordResetEmail, signInWithEmailAndPassword, signOut };
